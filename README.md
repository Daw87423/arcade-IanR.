# Arcade — 6 jeux avec comptes joueurs

Snake, 2048, Motus, Morpion, Pac-Man et Tetris réunis derrière **une seule connexion**.
...
- Les records sont enregistrés **par compte et par jeu** (Snake, 2048, Pac-Man, Tetris).
...
## Messagerie, présence et compte

- **Joueur connecté** : l'engrenage ⚙ ouvre « Mon compte » → écrire à l'administrateur
  ou supprimer son compte. (La connexion admin n'est plus proposée tant qu'un joueur
  est connecté.)
- **Administrateur** : se connecte via l'engrenage (quand personne n'est connecté) avec
  l'identifiant et le code admin. Il voit la liste des joueurs avec un **point vert**
  pour ceux en ligne (et « joue » s'ils sont sur un jeu), et peut **discuter** avec
  chaque joueur. Les joueurs reçoivent les messages de l'admin en notification sur
  toutes les pages.
- Stockage : comptes, présence et messages dans Netlify Blobs.
