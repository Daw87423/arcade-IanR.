import {
  usersStore, sessionsStore, hashPassword, newToken, json, getUser, readBody, ADMIN_ID,
} from '../lib/store.mjs';
...
export default async (req) => {
  ...
  if (key === ADMIN_ID.toLowerCase()) return json({ error: 'Cet identifiant est réservé.' }, 409);
